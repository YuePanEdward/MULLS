...
DEFINE_int32(initial_scan2scan_frame_num, 3, "only conduct scan to scan registration for the first　${initial_scan2scan_frame_num} frames");
...
DEFINE_int32(s2m_frequency, 1, "frequency of scan to map registration (Hz)");
...
int main(int argc, char **argv)
{
    ...
    cfilter.extract_semantic_pts(cblock_target, FLAGS_cloud_down_res, gf_grid_resolution, gf_max_grid_height_diff,
                                 ...
                                 FLAGS_linearity_thre_down, FLAGS_planarity_thre_down,
    ...
    for (int i = 1; i < frame_num; i++) //throughout all the used frames
    {
        ...
        if (!strcmp(FLAGS_baseline_reg_method.c_str(), "ndt"))                            //baseline_method
            ...
            cfilter.extract_semantic_pts(cblock_source, FLAGS_cloud_down_res, gf_grid_resolution, gf_max_grid_height_diff,
                                         ...
                                         FLAGS_linearity_thre_down, FLAGS_planarity_thre_down, FLAGS_adaptive_parameters_on, FLAGS_apply_scanner_filter,
